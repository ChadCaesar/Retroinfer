#!/bin/bash
# ============================================================
# E4: 聚类复用消融 (Reuse ON vs OFF)
# ============================================================
# Usage:
#   bash benchmark/run_e4_reuse.sh
#
# Configurable via env vars:
#   SKIP_THROUGHPUT=1  bash benchmark/run_e4_reuse.sh
#   ACCURACY_ONLY=1    bash benchmark/run_e4_reuse.sh
# ============================================================

set -euo pipefail
source "$(dirname "$0")/common_exp.sh"
setup_logging "E4_reuse"
...
# ============================================================
# Throughput comparison (main metric for E4)
# ============================================================
...
# ============================================================
log_msg "========== E4 Accuracy Spot Checks =========="

# LongBench sampling: 3 representative tasks
for reuse in "${REUSE_VALUES[@]}"; do
    log_msg "--- E4 LongBench: reuse=${reuse} ---"
